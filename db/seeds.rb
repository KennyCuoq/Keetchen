...
jethro = User.create!(email: 'e@e.com', password: "123456", first_name: "Jethro", last_name: "Williams")
john = User.create!(email: 'f@f.com', password: "123456", first_name: "John", last_name: "Ferreira")
jonas = User.create!(email: 'g@g.com', password: "123456", first_name: "Jonas", last_name: "Dieterle")
jules = User.create!(email:d 'h@h.com', password: "123456", first_name: "Jules", last_name: "Jamet")
merlin = User.create!(email: 'i@i.com', password: "123456", first_name: "Merlin", last_name: "Hannemann")
owain = User.create!(email: 'j@j.com', password: "123456", first_name: "Owain", last_name: "Skyrme")
paul = User.create!(email: 'k@k.com', password: "123456", first_name: "Paul", last_name: "Guadagnin")
roger = User.create!(email: 'l@l.com', password: "123456", first_name: "Roger", last_name: "G")
shawkat = User.create!(email: 'm@m.com', password: "123456", first_name: "Shawkat", last_name: "Shami")
stephen = User.create!(email: 'n@n.com', password: "123456", first_name: "Stephen", last_name: "Schuez")
victor = User.create!(email: 'o@o.com', password: "123456", first_name: "Victor", last_name: "King")
william = User.create!(email: 'p@p.com', password: "123456", first_name: "William", last_name: "Oleson")
